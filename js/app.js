(function () {
  ...
  const LOGIN_FLOW_VERSION = "jm-fluxo-operacional-v13-motorista-sequencial-automatico";
...
Rota: ${url}`;
  ...
  function aiReviewedCallPayload(index, draft) {
    ...
    reviewed.normalizedCall = {
      ...
      parserVersion: "jm-fluxo-operacional-v13-motorista-sequencial-automatico"
    };
  ...
  async function createOfficialCallFromAi(index) {
    ...
    const callData = compactForFirestore({
      ...
      aiReviewed: true,
      aiCreatedAt: now,
      aiParserVersion: "jm-fluxo-operacional-v13-motorista-sequencial-automatico",
