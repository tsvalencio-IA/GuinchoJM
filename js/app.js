(function () {
  ...
  const LOGIN_FLOW_VERSION = "jm-fluxo-operacional-v26-cache-refresh";
...
Rota: ${url}`;
  ...
  function aiReviewedCallPayload(index, draft) {
    ...
    reviewed.normalizedCall = {
      ...
      parserVersion: "jm-fluxo-operacional-v26-cache-refresh"
    };
  ...
  async function createOfficialCallFromAi(index) {
    ...
    const callData = compactForFirestore({
      ...
      aiReviewed: true,
      aiCreatedAt: now,
      aiParserVersion: "jm-fluxo-operacional-v26-cache-refresh",
